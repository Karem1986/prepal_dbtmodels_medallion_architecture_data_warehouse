...
The goal:to decrease the time it takes to make the power bi reports and use dbt to automate the ELT pipelines once I migrate from store procedures to dbt models, also to enhance collaboration, tracking and monitoring with other members of the Sofware Engineering team
